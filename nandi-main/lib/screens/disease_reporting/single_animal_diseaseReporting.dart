...
class SingleAnimalPage1 extends StatefulWidget {
  final data;
  SingleAnimalPage1({required this.data});

  @override
  _SingleAnimalPage1State createState() => _SingleAnimalPage1State();
}

class _SingleAnimalPage1State extends State<SingleAnimalPage1> {
